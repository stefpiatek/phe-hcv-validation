...
- FASTQs have been genrated from these FASTAs, mapped back to the consensus FASTA sequence and then quasi_bam run
...
- Gaps at around ~ 1,500 and ~7,000 nt seen in bam files, majority of FASTAs had gaps in these regions
- When determining discordant basecalls, mostly gaps are called
- No thymines are miscalled and few of the other bases
...
- These match to the gaps in the FASTAs, where the reference chooses a base in preference to a gap if there is at least one FASTA to support it at this position
- Read depth of < 1,500 seems to affect base frequencies at the ~ 1,500 nt position
- Small proportion of bases with supporting FASTAs have no reads supporting them in the quasibam (quality of NA, in grey)
