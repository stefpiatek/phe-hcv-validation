...
Example usage from command line:
    ...
    Rscript -e "rmarkdown::render('scripts/frequency-matrix_quasibam_comparison.Rmd', params = list(pipeline = 'vicuna_bwa', date_prefix = '170908') 'html_document', '../reports/170908_frequency-matrix_quasibam.html')"
