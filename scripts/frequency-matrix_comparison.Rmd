...
analyse_threshold(1, "consensus")
position_diff_export %>% knitr::kable()
conf_int_export %>% knitr::kable()

analyse_threshold(5, "consensus")
position_diff_export %>% knitr::kable()
conf_int_export %>% knitr::kable()

analyse_threshold(10, "consensus")
position_diff_export %>% knitr::kable()
conf_int_export %>% knitr::kable()
...
```{r vphaser, warning=FALSE, message=FALSE, echo=FALSE, results='asis'}
